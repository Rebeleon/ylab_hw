...
# Get submenus
@router.get('/{target_menu_id}/submenus', response_model=schemas.ListSubmenuResponse)
def get_submenus(db: Session = Depends(get_db)):
    ...
    return {'submenus': submenu_response}


# Get a single submenu
@router.get('/{target_menu_id}/submenus/{target_submenu_id}', response_model=schemas.SubmenuResponse)
